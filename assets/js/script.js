...
var displayDesiredDestination = function() {
    $("#static-destination-text").removeClass("display-block")
    $("#static-destination-text").addClass("display-none");
    ...
    for(var i=0; i<searchHistory.length; i++) {
        ...
        var searchedLocation = $('<button/>', {
            ...
            click: function() {
                ...
                $("#destination-text").text("You are going from " + $(this).text())
                $("#destination-text").addClass("display-block")
                $("#static-destination-text").removeClass("display-none")
                $("#static-destination-text").addClass("display-block")
                $("#static-destination-text").text("Please select your travel dates and continue.")
            }
        });
